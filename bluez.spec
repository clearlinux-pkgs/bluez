...
Version  : 5.78
Release  : 59
URL      : https://mirrors.kernel.org/pub/linux/bluetooth/bluez-5.78.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/bluetooth/bluez-5.78.tar.gz
...
%prep
%setup -q -n bluez-5.78
cd %{_builddir}/bluez-5.78
pushd ..
cp -a bluez-5.78 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725890383
