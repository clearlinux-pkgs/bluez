...
Version  : 5.66
Release  : 45
URL      : https://mirrors.kernel.org/pub/linux/bluetooth/bluez-5.66.tar.xz
Source0  : https://mirrors.kernel.org/pub/linux/bluetooth/bluez-5.66.tar.xz
...
%prep
%setup -q -n bluez-5.66
cd %{_builddir}/bluez-5.66
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668439015
...
/usr/lib64/libbluetooth.so.3.19.8
