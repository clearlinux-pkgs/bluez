...
Source0  : https://mirrors.kernel.org/pub/linux/bluetooth/bluez-5.62.tar.xz
...
%prep
%setup -q -n bluez-5.62
cd %{_builddir}/bluez-5.62
...
cp %{_builddir}/bluez-5.62/COPYING %{buildroot}/usr/share/package-licenses/bluez/a7a897a4bde987e597c04f16a9c28f6d3f57916d
cp %{_builddir}/bluez-5.62/COPYING.LIB %{buildroot}/usr/share/package-licenses/bluez/32c7c5556c56cdbb2d507e27d28d081595a35a9b
%make_install
