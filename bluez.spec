...
Version  : 5.73
Release  : 53
URL      : https://mirrors.kernel.org/pub/linux/bluetooth/bluez-5.73.tar.xz
Source0  : https://mirrors.kernel.org/pub/linux/bluetooth/bluez-5.73.tar.xz
...
%prep
%setup -q -n bluez-5.73
cd %{_builddir}/bluez-5.73
pushd ..
cp -a bluez-5.73 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709839755
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libbluetooth.so.3.19.13
/usr/lib64/libbluetooth.so.3
/usr/lib64/libbluetooth.so.3.19.13
