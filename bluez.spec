...
Version  : 5.79
Release  : 60
URL      : https://mirrors.kernel.org/pub/linux/bluetooth/bluez-5.79.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/bluetooth/bluez-5.79.tar.gz
...
%prep
%setup -q -n bluez-5.79
cd %{_builddir}/bluez-5.79
pushd ..
cp -a bluez-5.79 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730668678
