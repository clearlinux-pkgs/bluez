...
%prep
%setup -q -n bluez-5.64
cd %{_builddir}/bluez-5.64
...
cp %{_builddir}/bluez-5.64/COPYING.LIB %{buildroot}/usr/share/package-licenses/bluez/32c7c5556c56cdbb2d507e27d28d081595a35a9b
%make_install
