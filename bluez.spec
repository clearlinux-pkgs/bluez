...
Source0  : https://mirrors.kernel.org/pub/linux/bluetooth/bluez-5.72.tar.xz
...
%prep
%setup -q -n bluez-5.72
cd %{_builddir}/bluez-5.72
pushd ..
cp -a bluez-5.72 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706044232
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libbluetooth.so.3.19.12
/usr/lib64/libbluetooth.so.3
/usr/lib64/libbluetooth.so.3.19.12
